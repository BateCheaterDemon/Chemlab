...
# 修改 hydra 配置部分
@hydra.main(version_base=None, config_path="config", config_name="camera_config_depth")
def main(cfg: DictConfig):
    ...
    while simulation_app.is_running():
        ...
        if world.is_playing():
            ...
            object_position = object_utils.get_object_position(obj_path="/World/beaker")
            object_size = object_utils.get_object_size(obj_path="/World/beaker")
            ...
            if not pick_controller.is_done():
                ...
                # 判断最终烧杯位置
                final_beaker_position = object_utils.get_object_xform_position(obj_path="/World/beaker/mesh")
                if final_beaker_position is not None and final_beaker_position[2] > 0.85:
            ...
            if camera1_display is not None and camera2_display is not None:
                ...
                data_collector.cache_step(
                    camera1_record,
                    camera2_record,
                    my_franka.get_joint_positions()[:-1]
                )

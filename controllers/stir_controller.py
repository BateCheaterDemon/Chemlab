...
class StirController(BaseController):
    ...
    def forward(
        ...
        if self._event == 0:
            ...
            position_target = center_position + np.array([x_offset, y_offset, 0.1])  # Assuming stirring at fixed height
